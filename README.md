# 转型有术 · 企业 AI 每日早报（Routine + GitHub + 飞书 版）
...
```bash
# 在你本地解压本 zip
unzip zhuanxing-ai-daily-routine.zip
cd zhuanxing-ai-daily-routine

# 初始化 git
git init
git add .
git commit -m "init: zhuanxing-ai-daily routine 版骨架"

# 在 GitHub.com 上创建新 repo,名字建议: zhuanxing-ai-daily
# 然后:
git remote add origin git@github.com:你的用户名/zhuanxing-ai-daily.git
git branch -M main
...
|---|---|
| **Name** | `转型有术企业 AI 早报` |
| **Repository** | 你的用户名/zhuanxing-ai-daily |
| **Branch** | `main` |
